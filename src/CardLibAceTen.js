...
function preloadCards(scene) {
  ...
  scene.load.image('c13', 'assets/cards/white_c_10.svg');
  scene.load.image('c10', 'assets/cards/white_c_j.svg');
  scene.load.image('c11', 'assets/cards/white_c_q.svg');
  scene.load.image('c12', 'assets/cards/white_c_k.svg');
  ...
  scene.load.image('d13', 'assets/cards/white_d_10.svg');
  scene.load.image('d10', 'assets/cards/white_d_j.svg');
  scene.load.image('d11', 'assets/cards/white_d_q.svg');
  scene.load.image('d12', 'assets/cards/white_d_k.svg');
  ...
  scene.load.image('h13', 'assets/cards/white_h_10.svg');
  scene.load.image('h10', 'assets/cards/white_h_j.svg');
  scene.load.image('h11', 'assets/cards/white_h_q.svg');
  scene.load.image('h12', 'assets/cards/white_h_k.svg');
  ...
  scene.load.image('s13', 'assets/cards/white_s_10.svg');
  scene.load.image('s10', 'assets/cards/white_s_j.svg');
  scene.load.image('s11', 'assets/cards/white_s_q.svg');
  scene.load.image('s12', 'assets/cards/white_s_k.svg');
